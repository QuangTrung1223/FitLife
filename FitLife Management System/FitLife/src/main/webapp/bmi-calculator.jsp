...
<html lang="en">
    ...
    if (height && weight && height > 0 && weight > 0) {
        ...
        // LÀM TRÒN XUỐNG ĐẾN SỐ NGUYÊN (hàng đơn vị)
        const bmiDisplay = Math.floor(bmi);

        // Cập nhật preview (chỉ số nguyên)
        document.querySelector('.preview-number').textContent = bmiDisplay;

        // Phân loại vẫn dùng bmi thật
        let category = '';
        let categoryClass = '';
        if (bmi < 18.5) {
