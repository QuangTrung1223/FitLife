...
public class UserDashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Course> availableCourses = latestProgress != null && latestProgress.getBmiCategory() != null 
            ? courseDAO.getCoursesByBmiCategory(latestProgress.getBmiCategory()) 
            : courseDAO.getAllCourses();
        
        // Lấy lịch sử mua hàng từ OrderHistory
